...
public class HelloworldGeneratorTest extends BaseGeneratorTest {
  ...
  @Test public void test_Generate() throws Exception {
    PluginProtos.CodeGeneratorRequest request = loadJson("helloworld.okhttp.json");
    ...
    assertEquals(response.getFile(1).getName(), "com/example/helloworld/RpcHelloWorldDispatcher.java");
